...
const getGroundSnapCacheStore = (obstacles) => {
  ...
  if (!(obstacles._groundSnapCacheShared instanceof Map)) {
    obstacles._groundSnapCacheShared = new Map();
  }
  return obstacles._groundSnapCacheShared;
};
...
const getGroundSnapCacheKey = (x, y, width, height, options = {}) => ([
  ...
  normalizeJumpmapGroundSampleSpacing(options.sampleSpacing),
